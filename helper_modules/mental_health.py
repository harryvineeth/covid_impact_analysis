...
def plot_mental_health(mental_health_statewise, mental_health, mental_health_nationwide):
    ...
    col.header("Can we see the impact of vaccination rates?")
    col.markdown(
        "Although not nearly as clear as the impact of case rates, the implementation of a vaccination plan likely had a positive effect on mental health. We can see this most clearly in the period of heightened vaccination rates from January 2021 through July of 2021. April had the highest vaccination rates of 2021, and clearly marks a significant decrease in anxiety or depressive symptoms within states. Following April, and a steady decline of vaccinations, most states reach their lowest levels of symptoms captured in the survey. This may be attributed to a sense of safety provided knowing people are vaccinated and a hope that the pandemic may be over. We cannot assume vaccinations to be the only factor, however, as this also corresponds with a change in season. Many people are more depressed or anxious during winter months compared to spring and summer. The state of Hawaii offers counter evidence to this argument, as it follows the same trends and has no seasons.")
